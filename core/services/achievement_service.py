...
class AchievementService:
    ...
    def create_achievement(self, student_id: int, title: str, 
                         description: str, points: int = 10) -> Achievement:
        """创建新成就"""
        achievement_data = {
    ...
    def get_achievement_stats(self) -> dict:
        ...
        return {
            ...
            "avg_points_per_achievement": sum(a.points for a in achievements) / len(achievements) if achievements else 0
        }