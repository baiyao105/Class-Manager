...
class StudentService:
    ...
    def create_student(self, name: str, student_number: str, class_id: int, email: Optional[str] = None) -> Student:
        """创建新学生"""
        student_data = {"name": name, "student_number": student_number, "class_id": class_id, "email": email}
